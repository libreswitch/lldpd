...
// ASN.1 source
// file:////ws/poojamal/enterprize/hpe-build/src/ops-lldpd/src/snmp/LLDP-MIB.txt
// Produced by pysmi-0.0.6 at Thu Apr  7 05:00:48 2016
// On host hpnsw3716.rose.rdlabs.hpecorp.net platform Linux version
// 3.16.0-37-generic by user poojamal
...
void init_lldpMessageTxHoldMultiplier(void) {
    const oid lldpMessageTxHoldMultiplier_oid[] = {1, 0, 8802, 1, 1,
                                                   2, 1, 1,    2};
    netsnmp_register_scalar(netsnmp_create_handler_registration(
...
int handler_lldpMessageTxHoldMultiplier(netsnmp_mib_handler *handler,
    ...
    if (reqinfo->mode == MODE_GET) {
        const struct ovsrec_system *system_row = ovsrec_system_first(idl);
        ovsdb_get_lldpMessageTxHoldMultiplier(
            idl, system_row, &netsnmp_lldpMessageTxHoldMultiplier);
        snmp_set_var_typed_value(requests->requestvb, ASN_INTEGER,
...
int handler_lldpReinitDelay(netsnmp_mib_handler *handler,
    ...
    if (reqinfo->mode == MODE_GET) {
        const struct ovsrec_system *system_row = ovsrec_system_first(idl);
        ovsdb_get_lldpReinitDelay(idl, system_row, &netsnmp_lldpReinitDelay);
        snmp_set_var_typed_value(requests->requestvb, ASN_INTEGER,
...
int handler_lldpNotificationInterval(netsnmp_mib_handler *handler,
                                     ...
                                     netsnmp_request_info *requests) {
    if (reqinfo->mode == MODE_GET) {
        ovsdb_get_lldpNotificationInterval(idl,
...
int handler_lldpStatsRemTablesLastChangeTime(
    ...
    if (reqinfo->mode == MODE_GET) {
        ...
        snmp_set_var_typed_value(
            requests->requestvb, ASN_TIMETICKS,
...
void init_lldpStatsRemTablesInserts(void) {
    ...
    netsnmp_register_scalar(netsnmp_create_handler_registration(
        ...
        OID_LENGTH(lldpStatsRemTablesInserts_oid), HANDLER_CAN_RWRITE));
...
void init_lldpStatsRemTablesDeletes(void) {
    ...
    netsnmp_register_scalar(netsnmp_create_handler_registration(
        ...
        OID_LENGTH(lldpStatsRemTablesDeletes_oid), HANDLER_CAN_RWRITE));
...
void init_lldpStatsRemTablesAgeouts(void) {
    ...
    netsnmp_register_scalar(netsnmp_create_handler_registration(
        ...
        OID_LENGTH(lldpStatsRemTablesAgeouts_oid), HANDLER_CAN_RWRITE));
...
int handler_lldpLocChassisIdSubtype(netsnmp_mib_handler *handler,
                                    ...
                                    netsnmp_request_info *requests) {
    if (reqinfo->mode == MODE_GET) {
        ovsdb_get_lldpLocChassisIdSubtype(idl,
