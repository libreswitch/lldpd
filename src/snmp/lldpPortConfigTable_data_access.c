...
void lldpPortConfigTable_container_init(netsnmp_container **container_ptr_ptr,
                                        netsnmp_cache *cache) {
  DEBUGMSGTL(("verbose:lldpPortConfigTable:lldpPortConfigTable_container_init",
              "called\n"));
...
void lldpPortConfigTable_container_shutdown(netsnmp_container *container_ptr) {
  ...
  if (NULL == container_ptr) {
    snmp_log(LOG_ERR, "bad params to lldpPortConfigTable_container_shutdown\n");
    return;
  }
}

int lldpPortConfigTable_container_load(netsnmp_container *container) {
  DEBUGMSGTL(("verbose:lldpPortConfigTable:lldpPortConfigTable_container_load",
              "called\n"));
  ...
  OVSREC_INTERFACE_FOR_EACH(interface_row, idl) {
    ...
    ovsdb_get_lldpPortConfigPortNum(idl, interface_row, &lldpPortConfigPortNum);
    ...
    if (MFD_SUCCESS !=
        lldpPortConfigTable_indexes_set(rowreq_ctx, lldpPortConfigPortNum)) {
    ...
    rowreq_ctx->data.lldpPortConfigTLVsTxEnable = lldpPortConfigTLVsTxEnable;
...
void lldpPortConfigTable_container_free(netsnmp_container *container) {
  DEBUGMSGTL(("verbose:lldpPortConfigTable:lldpPortConfigTable_container_free",
              "called\n"));
}

int lldpPortConfigTable_row_prep(lldpPortConfigTable_rowreq_ctx *rowreq_ctx) {
  DEBUGMSGTL(
      ("verbose:lldpPortConfigTable:lldpPortConfigTable_row_prep", "called\n"));
